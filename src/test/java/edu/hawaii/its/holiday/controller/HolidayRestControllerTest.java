...
public class HolidayRestControllerTest {
    ...
    public void httpGetHolidaysByClosest() throws Exception {
        ...
        result = mockMvc.perform(get("/api/holidays/closest?date=2019-01-02&search-forward=&type=uh"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                .andExpect(jsonPath("data[0].description").value("Martin Luther King Jr. Day"))
                .andExpect(jsonPath("data[0].observedDateFull").value("January 21, 2019, Monday"))
                .andExpect(jsonPath("data[0].officialDateFull").value("January 21, 2019, Monday"))
                .andExpect(jsonPath("data[0].types[0].description").value("Bank"))
                .andExpect(jsonPath("data[0].types[1].description").value("Federal"))
                .andExpect(jsonPath("data[0].types[2].description").value("UH"))
                .andReturn();
        ...
        result = mockMvc.perform(get("/api/holidays/closest?date=2019-12-25&search-forward=true&type=uh"))
                ...
                .andExpect(jsonPath("data[0].observedDateFull").value("December 25, 2019, Wednesday"))
                .andExpect(jsonPath("data[0].officialDateFull").value("December 25, 2019, Wednesday"))
                .andExpect(jsonPath("data[0].types[0].description").value("Bank"))
                .andExpect(jsonPath("data[0].types[1].description").value("Federal"))
                .andExpect(jsonPath("data[0].types[2].description").value("UH"))
                .andReturn();
        ...
        result = mockMvc.perform(get("/api/holidays/closest?date=2019-12-26&search-forward=false&type=state"))
                ...
                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                .andExpect(jsonPath("data", hasSize(1)))
                .andExpect(jsonPath("data[0].description").value("Statehood Day"))
                .andReturn();
        assertNotNull(result);
        ...
        result = mockMvc.perform(get("/api/holidays/closest?date=2019-12-26&search-forward=&type="))
                ...
                .andExpect(jsonPath("data", hasSize(1)))
                .andExpect(jsonPath("data[0].description").value("New Year's Day"))
                .andExpect(jsonPath("data[0].observedDateFull").value("January 01, 2020, Wednesday"))
                .andExpect(jsonPath("data[0].officialDateFull").value("January 01, 2020, Wednesday"))
                .andExpect(jsonPath("data[0].types[0].description").value("Bank"))
                .andExpect(jsonPath("data[0].types[1].description").value("Federal"))
                .andExpect(jsonPath("data[0].types[2].description").value("UH"))
                .andReturn();
    ...
    public void holidaysByYearParam() throws Exception {
        ...
        MvcResult result = mockMvc.perform(get("/rest/inYear")
                ...
                .andExpect(jsonPath("data[9].description").value("Labor Day"))
                .andExpect(jsonPath("data[10].description").value("Discoverers' Day"))
                .andExpect(jsonPath("data[11].description").value("General Election Day"))
        ...
        mockMvc.perform(get("/rest/inYear")
                ...
                .andExpect(jsonPath("data[1].holidayTypes[0]").value("Bank"))
                .andExpect(jsonPath("data[1].holidayTypes[1]").value("Federal"))
                .andExpect(jsonPath("data[1].holidayTypes[2]").value("UH"))
                .andExpect(jsonPath("data[2].description").value("Presidents' Day"))
                ...
                .andExpect(jsonPath("data[2].holidayTypes[0]").value("Bank"))
                .andExpect(jsonPath("data[2].holidayTypes[1]").value("Federal"))
                .andExpect(jsonPath("data[2].holidayTypes[2]").value("UH"))
                .andExpect(jsonPath("data[3].description").value("Prince Kuhio Day"))
                ...
                .andExpect(jsonPath("data[5].holidayTypes[0]").value("Bank"))
                .andExpect(jsonPath("data[5].holidayTypes[1]").value("Federal"))
                .andExpect(jsonPath("data[5].holidayTypes[2]").value("UH"))
                .andExpect(jsonPath("data[6].description").value("King Kamehameha I Day"))
                ...
                .andExpect(jsonPath("data[7].holidayTypes[0]").value("Bank"))
                .andExpect(jsonPath("data[7].holidayTypes[1]").value("Federal"))
                .andExpect(jsonPath("data[7].holidayTypes[2]").value("UH"))
                .andExpect(jsonPath("data[8].description").value("Statehood Day"))
                ...
                .andExpect(jsonPath("data[9].holidayTypes[0]").value("Bank"))
                .andExpect(jsonPath("data[9].holidayTypes[1]").value("Federal"))
                .andExpect(jsonPath("data[9].holidayTypes[2]").value("UH"))
                .andExpect(jsonPath("data[10].description").value("Discoverers' Day"))
                ...
                .andExpect(jsonPath("data[11].observedDate").value("2013-11-11"))
                .andExpect(jsonPath("data[11].officialDate").value("2013-11-11"))
                .andExpect(jsonPath("data[11].holidayTypes[0]").value("Bank"))
                .andExpect(jsonPath("data[11].holidayTypes[1]").value("Federal"))
                .andExpect(jsonPath("data[11].holidayTypes[2]").value("UH"))
                .andExpect(jsonPath("data[12].description").value("Thanksgiving"))
                .andExpect(jsonPath("data[12].year").value("2013"))
                .andExpect(jsonPath("data[12].observedDate").value("2013-11-28"))
                .andExpect(jsonPath("data[12].officialDate").value("2013-11-28"))
                .andExpect(jsonPath("data[12].holidayTypes[0]").value("Bank"))
                .andExpect(jsonPath("data[12].holidayTypes[1]").value("Federal"))
                .andExpect(jsonPath("data[12].holidayTypes[2]").value("UH"))
                .andExpect(jsonPath("data[13].description").value("Christmas"))
                .andExpect(jsonPath("data[13].year").value("2013"))
                .andExpect(jsonPath("data[13].observedDate").value("2013-12-25"))
                .andExpect(jsonPath("data[13].officialDate").value("2013-12-25"))
                .andExpect(jsonPath("data[13].holidayTypes[0]").value("Bank"))
                .andExpect(jsonPath("data[13].holidayTypes[1]").value("Federal"))
                .andExpect(jsonPath("data[13].holidayTypes[2]").value("UH"))
                .andReturn();
        ...
        mockMvc.perform(get("/rest/inYear")
                ...
                .andExpect(jsonPath("data[10].holidayTypes[0]").value("Bank"))
                .andExpect(jsonPath("data[10].holidayTypes[1]").value("Federal"))
                .andExpect(jsonPath("data[10].holidayTypes[2]").value("UH"))
    ...
    public void httpGetTypes() throws Exception {
        MvcResult result = mockMvc.perform(get("/api/types"))
                ...
                .andExpect(jsonPath("data[2].description").value("UH"))
                .andExpect(jsonPath("data[3].description").value("State"))
                .andReturn();
        assertNotNull(result);
    }
